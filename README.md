...
## 💡 Suggestions
You can suggest features on the [Discussions page](https://github.com/MCreator-Examples/Tale-of-Biomes/discussions/categories/feature-requests) under the feature requests category.

## 🐞 Bug Reports
You can report an issue on the [Issues page](https://github.com/MCreator-Examples/Tale-of-Biomes/issues/new?assignees=&labels=Bug&projects=&template=Report-Bug.yml&title=%5BBug%5D%3A+) and fill out the form.
