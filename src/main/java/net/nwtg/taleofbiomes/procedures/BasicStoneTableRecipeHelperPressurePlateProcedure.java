...
public class BasicStoneTableRecipeHelperPressurePlateProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeTimer <= 0) {
			...
			if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup < 2) {
				{
					TaleOfBiomesModVariables.PlayerVariables _vars = entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES);
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.SHALE_PRESSURE_PLATE.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.BASALT_PRESSURE_PLATE.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MARBLE_PRESSURE_PLATE.get());
		}
