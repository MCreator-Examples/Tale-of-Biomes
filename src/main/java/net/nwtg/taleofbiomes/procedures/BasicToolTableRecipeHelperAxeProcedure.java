...
public class BasicToolTableRecipeHelperAxeProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			iSet0 = new ItemStack(TaleOfBiomesModItems.STONE_AXE_HEAD.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_GRIP.get());
			iSet2 = new ItemStack(TaleOfBiomesModItems.PIRUFF_STONE_AXE.get());
		} else if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 1) {
			iSet0 = new ItemStack(TaleOfBiomesModItems.PIRUFF_AXE_HEAD.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_GRIP.get());
			iSet2 = new ItemStack(TaleOfBiomesModItems.PIRUFF_AXE.get());
		}
