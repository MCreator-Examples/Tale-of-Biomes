...
public class BasicStoneTableRecipeHelperButtonProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.SHALE_BUTTON.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.BASALT_BUTTON.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MARBLE_BUTTON.get());
		}
