...
public class BasicToolTablePiruffAxePartConditionProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		return iSlot0.is(ItemTags.create(ResourceLocation.parse((sTag0).toLowerCase(java.util.Locale.ENGLISH)))) && iSlot1.is(ItemTags.create(ResourceLocation.parse((sTag0).toLowerCase(java.util.Locale.ENGLISH))))
				...
				&& iSlot6.is(ItemTags.create(ResourceLocation.parse((sTag0).toLowerCase(java.util.Locale.ENGLISH)))) && iSlot7.is(ItemTags.create(ResourceLocation.parse((sTag0).toLowerCase(java.util.Locale.ENGLISH))))
