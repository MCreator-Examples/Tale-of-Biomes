...
public class GenerateKilnRecipe2Procedure {
		...
		if (fmFile.exists()) {
			{
				try {
					...
					if (fmMain.has("recipes") && fmMain.get("recipes").isJsonObject()) {
						...
						fmRecipe1.addProperty("layer_2", "tale_of_biomes:clay_block");
						fmRecipe1.addProperty("layer_3", "tale_of_biomes:clay_block");
						fmRecipe1.addProperty("layer_4", "tale_of_biomes:clay_block");
						fmRecipe1.addProperty("display", "tale_of_biomes:clay_block");
						fmRecipe1.addProperty("output", "tale_of_biomes:bricks");
						fmRecipe1.addProperty("min_temperature", 900);
						fmRecipe1.addProperty("max_temperature", 1000);
