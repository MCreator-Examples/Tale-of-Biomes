...
public class BasicStoneTableMossyCobbledMarbleSlabConditionProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		String sTag0 = "";
		sTag0 = TaleOfBiomesModVariables.MapVariables.get(world).modNamespace + ":" + "recipes/mossy_cobbled_marble";
		iSlot0 = (new Object() {
