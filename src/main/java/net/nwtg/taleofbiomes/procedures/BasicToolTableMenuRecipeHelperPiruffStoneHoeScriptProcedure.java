...
public class BasicToolTableMenuRecipeHelperPiruffStoneHoeScriptProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipePage == 8) {
			headTag = TaleOfBiomesModVariables.MapVariables.get(world).modNamespace + ":" + "basic_tool_table/stone_hoe_head";
