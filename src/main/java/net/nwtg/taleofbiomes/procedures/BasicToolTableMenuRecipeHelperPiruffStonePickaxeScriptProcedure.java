...
public class BasicToolTableMenuRecipeHelperPiruffStonePickaxeScriptProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipePage == 9) {
			headTag = TaleOfBiomesModVariables.MapVariables.get(world).modNamespace + ":" + "basic_tool_table/stone_pickaxe_head";
