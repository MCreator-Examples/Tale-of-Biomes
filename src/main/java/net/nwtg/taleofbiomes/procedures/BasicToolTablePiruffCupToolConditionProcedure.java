...
public class BasicToolTablePiruffCupToolConditionProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		return iSlot0.is(ItemTags.create(ResourceLocation.parse((sTag0).toLowerCase(java.util.Locale.ENGLISH)))) && iSlot1.getItem() == ItemStack.EMPTY.getItem()
				...
				|| iSlot0.getItem() == ItemStack.EMPTY.getItem() && iSlot1.getItem() == ItemStack.EMPTY.getItem() && iSlot2.getItem() == ItemStack.EMPTY.getItem()
						&& iSlot3.is(ItemTags.create(ResourceLocation.parse((sTag0).toLowerCase(java.util.Locale.ENGLISH)))) && iSlot4.getItem() == ItemStack.EMPTY.getItem()
