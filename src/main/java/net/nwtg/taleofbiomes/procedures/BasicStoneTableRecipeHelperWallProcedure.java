...
public class BasicStoneTableRecipeHelperWallProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_SHALE_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.BASALT_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MARBLE_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.SHALE_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.COBBLED_BASALT_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.COBBLED_MARBLE_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.COBBLED_SHALE_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MOSSY_COBBLED_BASALT_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MOSSY_COBBLED_MARBLE_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MOSSY_COBBLED_SHALE_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_BASALT_WALL.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_MARBLE_WALL.get());
		}
