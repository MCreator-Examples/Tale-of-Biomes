...
public class BasicToolTableMenuRecipeHelperPiruffGripScriptProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipePage == 0) {
			stone = TaleOfBiomesModVariables.MapVariables.get(world).modNamespace + ":" + "basic_tool_table/piruff_wood";
