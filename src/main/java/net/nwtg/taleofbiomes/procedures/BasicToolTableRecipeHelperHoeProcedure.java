...
public class BasicToolTableRecipeHelperHoeProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			iSet0 = new ItemStack(TaleOfBiomesModItems.STONE_HOE_HEAD.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_GRIP.get());
			iSet2 = new ItemStack(TaleOfBiomesModItems.PIRUFF_STONE_HOE.get());
		} else if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 1) {
			iSet0 = new ItemStack(TaleOfBiomesModItems.PIRUFF_HOE_HEAD.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_GRIP.get());
			iSet2 = new ItemStack(TaleOfBiomesModItems.PIRUFF_HOE.get());
		}
