...
public class YellowPiruffBedBlockAddedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		...
		air = "minecraft:air";
		if (blockstate.getBlock() == TaleOfBiomesModBlocks.YELLOW_PIRUFF_BED.get()) {
			top = TaleOfBiomesModBlocks.YELLOW_PIRUFF_BED_TOP.get().defaultBlockState();
		} else if (blockstate.getBlock() == TaleOfBiomesModBlocks.PURPLE_PIRUFF_BED.get()) {
			top = TaleOfBiomesModBlocks.PURPLE_PIRUFF_BED_TOP.get().defaultBlockState();
		} else if (blockstate.getBlock() == TaleOfBiomesModBlocks.BLUE_PIRUFF_BED.get()) {
			top = TaleOfBiomesModBlocks.BLUE_PIRUFF_BED_TOP.get().defaultBlockState();
		} else if (blockstate.getBlock() == TaleOfBiomesModBlocks.LIGHT_PURPLE_PIRUFF_BED.get()) {
			top = TaleOfBiomesModBlocks.LIGHT_PURPLE_PIRUFF_BED_TOP.get().defaultBlockState();
		} else if (blockstate.getBlock() == TaleOfBiomesModBlocks.MAGENTA_PIRUFF_BED.get()) {
