...
public class BasicStoneTablePolishedBasaltSlabConditionProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		String sTag0 = "";
		sTag0 = TaleOfBiomesModVariables.MapVariables.get(world).modNamespace + ":" + "recipes/polished_basalt";
		iSlot0 = (new Object() {
