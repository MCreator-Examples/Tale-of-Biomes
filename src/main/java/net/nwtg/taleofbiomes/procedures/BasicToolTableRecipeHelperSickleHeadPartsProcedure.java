...
public class BasicToolTableRecipeHelperSickleHeadPartsProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.STONE_SICKLE_HEAD.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_SICKLE_HEAD.get());
		}
