...
public class BasicStoneTableRecipeHelperPolishedBlockProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_SHALE.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_BASALT.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_MARBLE.get());
		}
