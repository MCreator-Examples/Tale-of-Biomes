...
public class BasicToolTableRecipeHelperShovelProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			iSet0 = new ItemStack(TaleOfBiomesModItems.STONE_SHOVEL_HEAD.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_GRIP.get());
			iSet2 = new ItemStack(TaleOfBiomesModItems.PIRUFF_STONE_SHOVEL.get());
		} else if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 1) {
			iSet0 = new ItemStack(TaleOfBiomesModItems.PIRUFF_SHOVEL_HEAD.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_GRIP.get());
			iSet2 = new ItemStack(TaleOfBiomesModItems.PIRUFF_SHOVEL.get());
		}
