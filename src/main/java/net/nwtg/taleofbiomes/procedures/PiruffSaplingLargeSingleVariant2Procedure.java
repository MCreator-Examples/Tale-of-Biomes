...
public class PiruffSaplingLargeSingleVariant2Procedure {
			...
			if (!(airTag).isEmpty()) {
				...
				if (!dontSpawn && rotation == 0) {
					if (world instanceof ServerLevel _serverworld) {
						StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("tale_of_biomes", "piruff_tree_large_02n"));
						if (template != null) {
