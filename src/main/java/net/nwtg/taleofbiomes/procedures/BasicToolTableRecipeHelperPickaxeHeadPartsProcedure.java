...
public class BasicToolTableRecipeHelperPickaxeHeadPartsProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			iSet0 = new ItemStack(TaleOfBiomesModBlocks.STONE.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.STONE_PICKAXE_HEAD.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_PICKAXE_HEAD.get());
		}
