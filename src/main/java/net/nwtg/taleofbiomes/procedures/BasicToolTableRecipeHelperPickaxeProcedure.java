...
public class BasicToolTableRecipeHelperPickaxeProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		ItemStack iSet1 = ItemStack.EMPTY;
		ItemStack iSet0 = ItemStack.EMPTY;
		ItemStack iSet2 = ItemStack.EMPTY;
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeTimer <= 0) {
			...
			if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup < 1) {
				{
					TaleOfBiomesModVariables.PlayerVariables _vars = entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES);
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			iSet0 = new ItemStack(TaleOfBiomesModItems.STONE_PICKAXE_HEAD.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_GRIP.get());
			iSet2 = new ItemStack(TaleOfBiomesModItems.PIRUFF_STONE_PICKAXE.get());
		} else if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 1) {
			iSet0 = new ItemStack(TaleOfBiomesModItems.PIRUFF_PICKAXE_HEAD.get());
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_GRIP.get());
			iSet2 = new ItemStack(TaleOfBiomesModItems.PIRUFF_PICKAXE.get());
		}
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
			ItemStack _setstack = iSet2.copy();
			_setstack.setCount(1);
