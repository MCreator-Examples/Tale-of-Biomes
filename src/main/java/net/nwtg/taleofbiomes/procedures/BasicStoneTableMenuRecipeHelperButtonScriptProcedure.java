...
public class BasicStoneTableMenuRecipeHelperButtonScriptProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipePage == 7) {
			stone = TaleOfBiomesModVariables.MapVariables.get(world).modNamespace + ":" + "basic_stone_table/button";
