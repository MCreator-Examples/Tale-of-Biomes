...
public class GenerateKilnRecipe3Procedure {
		...
		if (fmFile.exists()) {
			{
				try {
					...
					if (fmMain.has("recipes") && fmMain.get("recipes").isJsonObject()) {
						...
						fmRecipe1.addProperty("layer_2", "tale_of_biomes:pure_copper_dust_block");
						fmRecipe1.addProperty("layer_3", "tale_of_biomes:pure_copper_dust_block");
						fmRecipe1.addProperty("layer_4", "tale_of_biomes:pure_copper_dust_block");
						fmRecipe1.addProperty("display", "tale_of_biomes:pure_copper_dust_block");
						...
						fmRecipe1.addProperty("amount", 64);
