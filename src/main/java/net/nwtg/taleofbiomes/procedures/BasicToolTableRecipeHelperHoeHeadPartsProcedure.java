...
public class BasicToolTableRecipeHelperHoeHeadPartsProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.STONE_HOE_HEAD.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_HOE_HEAD.get());
		}
