				...
				try {
					...
					if (fmObjRoot.has("crops") && fmObjRoot.get("crops").isJsonObject()) {
						...
						if (!fmObjCrops.has(sBlockRegistry)) {
							...
							fmObjLight.addProperty("min_critical_time", 24000);
							fmObjLight.addProperty("min_critical_temperature", 15);
							fmObjLight.addProperty("max_critical_temperature", 40);
							fmObjLight.addProperty("min_growth_temperature", 20);
							fmObjLight.addProperty("max_growth_temperature", 35);
