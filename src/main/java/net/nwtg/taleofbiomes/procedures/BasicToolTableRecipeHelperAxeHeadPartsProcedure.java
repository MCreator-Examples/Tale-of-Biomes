...
public class BasicToolTableRecipeHelperAxeHeadPartsProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.STONE_AXE_HEAD.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_AXE_HEAD.get());
		}
