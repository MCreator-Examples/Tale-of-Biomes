...
public class CraftingTableRecipeHelperBasicCraftingTableProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_STICK.get());
			iSet2 = new ItemStack(TaleOfBiomesModBlocks.BASIC_TOOL_TABLE.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModItems.PIRUFF_STICK.get());
			iSet2 = new ItemStack(TaleOfBiomesModBlocks.BASIC_STONE_TABLE.get());
		}
