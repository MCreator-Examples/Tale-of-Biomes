...
public class BasicStoneTableRecipeHelperSlabProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(TaleOfBiomesModVariables.PLAYER_VARIABLES).recipeGroup == 0) {
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_SHALE_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.BASALT_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MARBLE_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.SHALE_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.COBBLED_BASALT_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.COBBLED_MARBLE_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.COBBLED_SHALE_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MOSSY_COBBLED_BASALT_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MOSSY_COBBLED_MARBLE_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.MOSSY_COBBLED_SHALE_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_BASALT_SLAB.get());
			...
			iSet1 = new ItemStack(TaleOfBiomesModBlocks.POLISHED_MARBLE_SLAB.get());
		}
