...
public class TaleOfBiomesMod {
	...
	public TaleOfBiomesMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		TaleOfBiomesModBlocks.REGISTRY.register(bus);
		TaleOfBiomesModBlockEntities.REGISTRY.register(bus);
		TaleOfBiomesModItems.REGISTRY.register(bus);

		TaleOfBiomesModTabs.REGISTRY.register(bus);
		TaleOfBiomesModFeatures.REGISTRY.register(bus);
		StructureFeature.REGISTRY.register(bus);
		TaleOfBiomesModMobEffects.REGISTRY.register(bus);

		TaleOfBiomesModMenus.REGISTRY.register(bus);
	}
