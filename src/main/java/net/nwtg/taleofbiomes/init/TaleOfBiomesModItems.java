...
public class TaleOfBiomesModItems {
	...
	public static final DeferredHolder<Item, Item> PIRUFF_STICK = REGISTRY.register("piruff_stick", PiruffStickItem::new);
	public static final DeferredHolder<Item, Item> ROSE_QUARTZ_BLOCK = block(TaleOfBiomesModBlocks.ROSE_QUARTZ_BLOCK);
	public static final DeferredHolder<Item, Item> ROSE_QUARTZ_BUDDING = block(TaleOfBiomesModBlocks.ROSE_QUARTZ_BUDDING);
	public static final DeferredHolder<Item, Item> ROSE_QUARTZ_CLUSTER = block(TaleOfBiomesModBlocks.ROSE_QUARTZ_CLUSTER);
	public static final DeferredHolder<Item, Item> PIRUFF_CUP = REGISTRY.register("piruff_cup", PiruffCupItem::new);
	public static final DeferredHolder<Item, Item> PIRUFF_WATER_CUP = REGISTRY.register("piruff_water_cup", PiruffWaterCupItem::new);
	public static final DeferredHolder<Item, Item> ROSE_QUARTZ_SHARD = REGISTRY.register("rose_quartz_shard", RoseQuartzShardItem::new);
	public static final DeferredHolder<Item, Item> CRAFTING_TABLE = block(TaleOfBiomesModBlocks.CRAFTING_TABLE);
	public static final DeferredHolder<Item, Item> PIRUFF_BARREL = block(TaleOfBiomesModBlocks.PIRUFF_BARREL);
	public static final DeferredHolder<Item, Item> ELDENMOOR_COPPER_ORE = block(TaleOfBiomesModBlocks.ELDENMOOR_COPPER_ORE);
	public static final DeferredHolder<Item, Item> RAW_PURE_COPPER = REGISTRY.register("raw_pure_copper", RawPureCopperItem::new);
	public static final DeferredHolder<Item, Item> RAW_MIXED_COPPER = REGISTRY.register("raw_mixed_copper", RawMixedCopperItem::new);
	public static final DeferredHolder<Item, Item> RAW_IMPURE_COPPER = REGISTRY.register("raw_impure_copper", RawImpureCopperItem::new);
	...
	public static final DeferredHolder<Item, Item> IMPURE_COPPER_DUST = REGISTRY.register("impure_copper_dust", ImpureCopperDustItem::new);
	...
	public static final DeferredHolder<Item, Item> IMPURE_COPPER_DUST_BLOCK = block(TaleOfBiomesModBlocks.IMPURE_COPPER_DUST_BLOCK);
	public static final DeferredHolder<Item, Item> RAW_PURE_COPPER_BLOCK = block(TaleOfBiomesModBlocks.RAW_PURE_COPPER_BLOCK);
	public static final DeferredHolder<Item, Item> RAW_MIXED_COPPER_BLOCK = block(TaleOfBiomesModBlocks.RAW_MIXED_COPPER_BLOCK);
	public static final DeferredHolder<Item, Item> RAW_IMPURE_COPPER_BLOCK = block(TaleOfBiomesModBlocks.RAW_IMPURE_COPPER_BLOCK);
	public static final DeferredHolder<Item, Item> WILD_PIRUFF_CARROTS = block(TaleOfBiomesModBlocks.WILD_PIRUFF_CARROTS);
	public static final DeferredHolder<Item, Item> PIRUFF_CARROT = REGISTRY.register("piruff_carrot", PiruffCarrotItem::new);
