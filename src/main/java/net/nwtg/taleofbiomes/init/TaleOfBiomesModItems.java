...
public class TaleOfBiomesModItems {
	...
	public static final DeferredItem<Item> PRAIRIE_DOG_SPAWN_EGG = REGISTRY.register("prairie_dog_spawn_egg", () -> new DeferredSpawnEggItem(TaleOfBiomesModEntities.PRAIRIE_DOG, -5602204, -661555, new Item.Properties()));
	...
	public static class ItemsClientSideHandler {
		...
		public static void clientLoad(FMLClientSetupEvent event) {
			event.enqueueWork(() -> {
				ItemProperties.register(SEASON_DEVICE.get(), ResourceLocation.parse("tale_of_biomes:season_device_season_id"),
