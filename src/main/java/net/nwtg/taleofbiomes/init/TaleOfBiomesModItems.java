...
public class TaleOfBiomesModItems {
	...
	public static final RegistryObject<Item> PIRUFF_STONE_SICKLE = REGISTRY.register("piruff_stone_sickle", () -> new PiruffStoneSickleItem());
	...
	public static final RegistryObject<Item> STONE_SICKLE_HEAD = REGISTRY.register("stone_sickle_head", () -> new StoneSickleHeadItem());
	...
	public static final RegistryObject<Item> MOSS_BLOCK = block(TaleOfBiomesModBlocks.MOSS_BLOCK);
	public static final RegistryObject<Item> MOSS_CARPET = block(TaleOfBiomesModBlocks.MOSS_CARPET);
	public static final RegistryObject<Item> PIRUFF_VINES = block(TaleOfBiomesModBlocks.PIRUFF_VINES);
	...
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_E = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_E);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_I = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_I);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_L = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_L);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_LC = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_LC);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_LCC = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_LCC);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_LT = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_LT);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_LTC = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_LTC);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_T = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_T);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_TC = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_TC);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_TX = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_TX);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_TXC = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_TXC);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_TXCC = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_TXCC);
	public static final RegistryObject<Item> LOW_CAPACITY_CABLE_X = block(TaleOfBiomesModBlocks.LOW_CAPACITY_CABLE_X);
