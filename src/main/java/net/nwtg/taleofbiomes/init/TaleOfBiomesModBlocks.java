...
public class TaleOfBiomesModBlocks {
	...
	public static final RegistryObject<Block> MOSS_CARPET = REGISTRY.register("moss_carpet", () -> new MossCarpetBlock());
	public static final RegistryObject<Block> PIRUFF_VINES = REGISTRY.register("piruff_vines", () -> new PiruffVinesBlock());
	...
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_N = REGISTRY.register("low_capacity_cable_n", () -> new LowCapacityCableNBlock());
	...
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_E = REGISTRY.register("low_capacity_cable_e", () -> new LowCapacityCableEBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_I = REGISTRY.register("low_capacity_cable_i", () -> new LowCapacityCableIBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_L = REGISTRY.register("low_capacity_cable_l", () -> new LowCapacityCableLBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_LC = REGISTRY.register("low_capacity_cable_lc", () -> new LowCapacityCableLCBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_LCC = REGISTRY.register("low_capacity_cable_lcc", () -> new LowCapacityCableLCCBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_LT = REGISTRY.register("low_capacity_cable_lt", () -> new LowCapacityCableLTBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_LTC = REGISTRY.register("low_capacity_cable_ltc", () -> new LowCapacityCableLTCBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_T = REGISTRY.register("low_capacity_cable_t", () -> new LowCapacityCableTBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_TC = REGISTRY.register("low_capacity_cable_tc", () -> new LowCapacityCableTCBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_TX = REGISTRY.register("low_capacity_cable_tx", () -> new LowCapacityCableTXBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_TXC = REGISTRY.register("low_capacity_cable_txc", () -> new LowCapacityCableTXCBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_TXCC = REGISTRY.register("low_capacity_cable_txcc", () -> new LowCapacityCableTXCCBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_X = REGISTRY.register("low_capacity_cable_x", () -> new LowCapacityCableXBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_XC = REGISTRY.register("low_capacity_cable_xc", () -> new LowCapacityCableXCBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_F = REGISTRY.register("low_capacity_cable_f", () -> new LowCapacityCableFBlock());
	public static final RegistryObject<Block> LOW_CAPACITY_CABLE_S = REGISTRY.register("low_capacity_cable_s", () -> new LowCapacityCableSBlock());
	public static final RegistryObject<Block> SOLAR_PANNEL = REGISTRY.register("solar_pannel", () -> new SolarPannelBlock());
	public static final RegistryObject<Block> PIRUFF_SAPLING = REGISTRY.register("piruff_sapling", () -> new PiruffSaplingBlock());
	public static final RegistryObject<Block> COPPER_BATTERY_0 = REGISTRY.register("copper_battery_0", () -> new CopperBattery0Block());
	public static final RegistryObject<Block> COPPER_BATTERY_1 = REGISTRY.register("copper_battery_1", () -> new CopperBattery1Block());
	public static final RegistryObject<Block> COPPER_BATTERY_2 = REGISTRY.register("copper_battery_2", () -> new CopperBattery2Block());
	public static final RegistryObject<Block> COPPER_BATTERY_3 = REGISTRY.register("copper_battery_3", () -> new CopperBattery3Block());
	public static final RegistryObject<Block> COPPER_BATTERY_4 = REGISTRY.register("copper_battery_4", () -> new CopperBattery4Block());
