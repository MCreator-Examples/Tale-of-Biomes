...
import net.nwtg.taleofbiomes.procedures.BasicToolTableMenuRecipeBookWhileThisGUIIsOpenTickProcedure;
import net.nwtg.taleofbiomes.procedures.BasicToolTableMenuRecipeBookThisGUIIsOpenedProcedure;
...
public class BasicToolTableMenuRecipeBookMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BasicToolTableMenuRecipeBookMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		BasicToolTableMenuRecipeBookThisGUIIsOpenedProcedure.execute(entity);
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof BasicToolTableMenuRecipeBookMenu) {
			...
			BasicToolTableMenuRecipeBookWhileThisGUIIsOpenTickProcedure.execute(world, entity);
		}
	}
}
