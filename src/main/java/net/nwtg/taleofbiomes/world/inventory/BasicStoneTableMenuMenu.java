...
import net.nwtg.taleofbiomes.procedures.BasicStoneTableMenuWhileThisGUIIsOpenTickProcedure;
import net.nwtg.taleofbiomes.procedures.BasicStoneTableMenuThisGUIIsOpenedProcedure;
import net.nwtg.taleofbiomes.network.BasicStoneTableMenuSlotMessage;
...
public class BasicStoneTableMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BasicStoneTableMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TaleOfBiomesModMenus.BASIC_STONE_TABLE_MENU.get(), id);
		...
		BasicStoneTableMenuThisGUIIsOpenedProcedure.execute(entity);
	}
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			PacketDistributor.SERVER.noArg().send(new BasicStoneTableMenuSlotMessage(slotid, x, y, z, ctype, meta));
			BasicStoneTableMenuSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof BasicStoneTableMenuMenu) {
