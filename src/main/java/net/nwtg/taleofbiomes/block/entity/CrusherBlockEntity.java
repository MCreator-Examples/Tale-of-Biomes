...
public class CrusherBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public CrusherBlockEntity(BlockPos position, BlockState state) {
		super(TaleOfBiomesModBlockEntities.CRUSHER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CrusherUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
