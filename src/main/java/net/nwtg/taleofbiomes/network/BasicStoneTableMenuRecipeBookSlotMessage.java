...
public record BasicStoneTableMenuRecipeBookSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(TaleOfBiomesMod.MODID, "basic_stone_table_menu_recipe_book_slots");
	public BasicStoneTableMenuRecipeBookSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final BasicStoneTableMenuRecipeBookSlotMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TaleOfBiomesMod.addNetworkMessage(BasicStoneTableMenuRecipeBookSlotMessage.ID, BasicStoneTableMenuRecipeBookSlotMessage::new, BasicStoneTableMenuRecipeBookSlotMessage::handleData);
	}
}
