...
public record BasicToolTableMenuSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(TaleOfBiomesMod.MODID, "basic_tool_table_menu_slots");
	public BasicToolTableMenuSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final BasicToolTableMenuSlotMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TaleOfBiomesMod.addNetworkMessage(BasicToolTableMenuSlotMessage.ID, BasicToolTableMenuSlotMessage::new, BasicToolTableMenuSlotMessage::handleData);
	}
}
