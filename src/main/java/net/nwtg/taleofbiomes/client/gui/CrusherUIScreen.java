...
public class CrusherUIScreen extends AbstractContainerScreen<CrusherUIMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("tale_of_biomes:textures/screens/crusher_ui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.tale_of_biomes.crusher_ui.label_crusher"), 5, 5, -12829636, false);
	}
